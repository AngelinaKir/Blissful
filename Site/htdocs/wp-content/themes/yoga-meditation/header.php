						...
						<div class="row">
							<div class="col-lg-9 col-md-9 align-self-center">
								<?php if( get_theme_mod('yoga_meditation_email') != '' ){ ?>
									<span><i class="fas fa-envelope me-3"></i><?php echo esc_html(get_theme_mod('yoga_meditation_email','')); ?></span>
								<?php }?>
								<?php if( get_theme_mod('yoga_studio_phone') != ''){ ?>
									<span class="ms-md-4"><i class="fas fa-phone me-3"></i><?php echo esc_html(get_theme_mod('yoga_studio_phone','')); ?></span>
								<?php }?>
								<?php if( get_theme_mod('yoga_studio_address') != ''){ ?>
									<span class="ms-md-4"><i class="fas fa-map-marker-alt me-3"></i><?php echo esc_html(get_theme_mod('yoga_studio_address','')); ?></span>
								<?php }?>
							</div>
