...
<div class="theme-offer">
  ...
  if(isset($_GET['import-demo'])){
    ...
    if (!$menu_exists) {
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Home', 'yoga-studio'),
      ...
      $parent_page_item_id = wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Pages', 'yoga-studio'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'   => __('Page Left Sidebar', 'yoga-studio'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'   => __('Page Right Sidebar', 'yoga-studio'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('About Us', 'yoga-studio'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Classes', 'yoga-studio'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Trainers', 'yoga-studio'),
    ...
    set_theme_mod( 'yoga_studio_top_text', 'We are the most popular Yoga Studio in town.' ); 
    ...
    $service_title=array('Vinyasa Yoga','Basic Yoga','Meditation Yoga','Astanga Yoga','Yoga In Pregnancy','Hatha Yoga');

    set_theme_mod( 'yoga_studio_service_count', '6' );
  ...
  <p class="note"><?php esc_html_e("If your website is already live and containing data, please make a backup.This importer will override the Yoga Studio's new customizable values.",'yoga-studio'); ?></p>
  <form id="mep-demo-importer-form" action="<?php echo esc_url(home_url()); ?>/wp-admin/themes.php?page=yoga-studio-guide-page" method="POST">
    <input type="submit" name="submit" value="<?php echo esc_attr( __('Begin With Demo Import', 'yoga-studio') ); ?>" class="button button-primary button-large">
    <a href="<?php echo esc_url(home_url('/')); ?>" target="_blank" class="button button-primary button-large"><?php esc_html_e('View Site','yoga-studio'); ?></a>
  </form>
  <div class="mep-spinner-div"><p class="spinner"></p></div>
  <div class="success">
    <?php if (isset($_GET['import-demo'])) {
       echo esc_html(__('Demo Import Successful', 'yoga-studio'));
    } ?>
  </div>
