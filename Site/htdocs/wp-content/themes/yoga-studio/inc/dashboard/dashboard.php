...
function yoga_studio_gettingstarted() {
	add_theme_page( esc_html__('Begin Installation', 'yoga-studio'), esc_html__('Begin Installation', 'yoga-studio'), 'edit_theme_options', 'yoga-studio-guide-page', 'yoga_studio_guide');
}
...
if ( ! defined( 'YOGA_STUDIO_LIVE_DEMO' ) ) {
	define('YOGA_STUDIO_LIVE_DEMO',__('https://trial.ovationthemes.com/yoga-studio-pro/','yoga-studio'));
}
if ( ! defined( 'YOGA_STUDIO_BUY_PRO' ) ) {
	define('YOGA_STUDIO_BUY_PRO',__('https://www.ovationthemes.com/products/yoga-wordpress-theme','yoga-studio'));
}
if ( ! defined( 'YOGA_STUDIO_PRO_DOC' ) ) {
	define('YOGA_STUDIO_PRO_DOC',__('https://trial.ovationthemes.com/docs/ot-yoga-studio-pro-doc/','yoga-studio'));
}
if ( ! defined( 'YOGA_STUDIO_FREE_DOC' ) ) {
define('YOGA_STUDIO_FREE_DOC',__('https://trial.ovationthemes.com/docs/ot-yoga-studio-free-doc/','yoga-studio'));
}
...
function yoga_studio_guide() {
	...
	<div class="getting-started__header">
		<div class="header-box-left">
			<h2><?php echo esc_html( $yoga_studio_theme ); ?></h2>
			<p><?php esc_html_e('Version: ', 'yoga-studio'); ?><?php echo esc_html($yoga_studio_theme['Version']);?></p>
		</div>
		<div class="header-box-right">
			<div class="btn_box">
				<a class="button-primary" href="<?php echo esc_url( YOGA_STUDIO_FREE_DOC ); ?>" target="_blank"><?php esc_html_e('Theme Documentation', 'yoga-studio'); ?></a>
	...
	<div class="import-box">
		<div class="box-container">
			<h2><?php esc_html_e( 'DEMO IMPORT', 'yoga-studio' ); ?></h2>
			<p><?php esc_html_e('To import all of the demo content, click the Begin With Demo Import button.','yoga-studio'); ?></p>
	...
	<div class="wrap getting-started">
		<div class="box-container">
			...
			<div class="box-right-main">
				...
				<img class="yoga_studio_img_responsive" style="width: 100%;" src="<?php echo esc_url( $yoga_studio_theme->get_screenshot() ); ?>" />
				<div class="pro-links">
					<hr>
