 ...
 * Control - Switch.
 *
 * @package Yoga coach Theme
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Yoga_Studio_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'yoga-studio-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'yoga-studio-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
