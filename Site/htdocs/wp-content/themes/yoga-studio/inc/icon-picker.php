...
class Yoga_Studio_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'yoga-studio' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $yoga_studio_font_awesome_icon_array = yoga_studio_font_awesome_icon_array();
                    foreach ($yoga_studio_font_awesome_icon_array as $yoga_studio_font_awesome_icon) {
                            $icon_class = $this->value() == $yoga_studio_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($yoga_studio_font_awesome_icon).'"></i>
                            <span class="yoga-studio-social-class">'.esc_attr($yoga_studio_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function yoga_studio_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'yoga-studio-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'yoga_studio_customizer_script' );

if(!function_exists('yoga_studio_font_awesome_icon_array')){
    function yoga_studio_font_awesome_icon_array(){
